...
public class FuncionarioTerceirizadoTest {
    ...
    public void testarConstrutorEntradaDespesasInvalida() {
        Exception ex = assertThrows(IllegalArgumentException.class, () -> {
            new FuncionarioTerceirizado("Laura", 30, 10.0, 1500.0);
        });
    ...
    public void testarConstrutorEntradasValida() {
        assertDoesNotThrow(() -> {
            new FuncionarioTerceirizado("Laura", 30, 10.0, 500.0);
        });
    }

    @Test
    public void testarModificarDespesasInvalida() {
        FuncionarioTerceirizado f = new FuncionarioTerceirizado("Laura", 30, 10.0, 400.0);
        Exception ex = assertThrows(IllegalArgumentException.class, () -> {
